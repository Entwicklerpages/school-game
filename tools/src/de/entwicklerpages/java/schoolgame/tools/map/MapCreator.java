...
public final class MapCreator
{
    ...
    public static String createMap()
    {
        ...
        mapCode.append(HEAD);
        mapCode.append(LAYER.replaceAll(REGEX_LAYER, "Hintergrund"));
        mapCode.append(LAYER.replaceAll(REGEX_LAYER, "Dekoration"));
        mapCode.append(OBJECTS);
        mapCode.append(LAYER.replaceAll(REGEX_LAYER, "Vordergrund"));
        mapCode.append(FOOTER);

        return mapCode.toString();
    }

    private static String REGEX_LAYER = "\\{\\{LAYER_NAME\\}\\}";
