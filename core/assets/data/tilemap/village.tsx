...
<tileset name="village" tilewidth="32" tileheight="32" tilecount="72" columns="8">
 <image source="village_map.png" width="256" height="288"/>
 <terraintypes>
   <terrain name="Wasser" tile="39"/>
   <terrain name="Rasen" tile="16"/>
   <terrain name="Sand" tile="42"/>
  </terraintypes>
  ...
  <tile id="33" terrain="1,2,2,2"/>
  <tile id="34" terrain="1,1,2,2"/>
  <tile id="35" terrain="2,2,1,1"/>
  <tile id="36" terrain="1,2,1,1"/>
  <tile id="37" terrain="2,1,1,1"/>
