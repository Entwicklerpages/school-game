...
<tileset name="Test" tilewidth="32" tileheight="32" spacing="1" margin="1" tilecount="48" columns="8">
 <image source="test_spacing.png" width="265" height="199"/>
 <terraintypes>
  <terrain name="Rasen" tile="29"/>
  <terrain name="Ziegel" tile="9"/>
  <terrain name="Gestein" tile="33"/>
  <terrain name="Wasser" tile="14"/>
 </terraintypes>
